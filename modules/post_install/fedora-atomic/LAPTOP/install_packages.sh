...
install_packages(){
    ...
    sqlite-devel openssl-devel libevent-devel systemd-devel mysql-devel postgresql-devel zlib-devel pcre2-devel python3-devel openrgb k3b \
    xfburn steam-devices goverlay dnfdragora driverctl clamav clamav-update clamd firewall-applet zenity
...
attempt_to_install_broken_apps(){
    ...
    sudo rpm-ostree install akmod-nvidia xorg-x11-drv-nvidia akmod-nvidia xorg-x11-drv-nvidia-cuda akmod-v4l2loopback \
    v4l2loopback gamemode.i686 make gcc
...
install_flatpaks(){
    ...
    io.github.thetumultuousunicornofdarkness.cpu-x com.vysp3r.ProtonPlus com.github.Matoking.protontricks
    #kde
